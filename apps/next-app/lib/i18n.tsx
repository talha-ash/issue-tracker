...
export const translations: Translations = {
  ...
  'auth.signin.subtitle': { en: 'Sign in to continue to your workspace', es: 'Inicia sesión para continuar a tu espacio de trabajo' },
  ...
  'auth.confirm.password': { en: 'Confirm Password', es: 'Confirmar contraseña' },
  ...
  'auth.have.account': { en: 'Already have an account?', es: '¿Ya tienes cuenta?' },
  'auth.or': { en: 'or', es: 'o' },
  ...
  'project.private.desc': { en: 'Only invited members can access', es: 'Solo miembros invitados pueden acceder' },
  'project.public': { en: 'Public', es: 'Público' },
  'project.public.desc': { en: 'Anyone in the workspace can view', es: 'Cualquiera en el espacio puede ver' },
  'project.members': { en: 'Members', es: 'Miembros' },
  'project.add.members': { en: 'Add Members', es: 'Agregar miembros' },
  'project.search.members': { en: 'Search by name or email...', es: 'Buscar por nombre o correo...' },
  ...
  'project.setup': { en: 'Set up a new project and invite your team', es: 'Configura un nuevo proyecto e invita a tu equipo' },
  ...
  'issue.write.comment': { en: 'Write a comment...', es: 'Escribe un comentario...' },
  ...
  'empty.issues.desc': { en: 'This project has no issues. Start by creating one.', es: 'Este proyecto no tiene incidencias. Comienza creando una.' },
  'empty.projects': { en: 'No projects yet', es: 'Sin proyectos aún' },
  'empty.projects.desc': { en: 'Create your first project to get started.', es: 'Crea tu primer proyecto para comenzar.' },
